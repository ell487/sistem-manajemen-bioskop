        ...
        <div class="sign-in card mx-auto shadow-lg">
          <div class="card-body py-8 px-lg-5">
            <a href="{{route("landing-page")}}" class="mb-8 hstack justify-content-center">
              <img src="{{ asset('assets/images/logos/logo-dark.svg') }}" alt="logo-dark" class="img-fluid">
            </a>
            ...
            <form class="d-flex flex-column gap-3" method="POST" action="{{ route('register') }}">
              @csrf

              {{-- Name --}}
              <div>
                <input type="text" name="name" value="{{ old('name') }}"
                  class="form-control border-bottom @error('name') is-invalid @enderror" placeholder="Name" required>
              ...
              <div>
                <input type="email" name="email" value="{{ old('email') }}"
                  class="form-control border-bottom @error('email') is-invalid @enderror" placeholder="Email" required>
              ...
              <div>
                <input type="password" name="password"
                  class="form-control border-bottom @error('password') is-invalid @enderror" placeholder="Password"
                  required>
              ...
              {{-- Confirm Password --}}
              <div>
                <input type="password" name="password_confirmation" class="form-control border-bottom"
            ...
            <p class="text-center mb-1 d-block fw-medium">By creating an account, you agree with our <a
                class="text-dark" href="privacy-policy.html">Privacy</a> and <a class="text-dark"
                href="privacy-policy.html">Policy</a>.</p>
